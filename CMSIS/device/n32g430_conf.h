...
* of the People鈥檚 Republic of China and other applicable jurisdictions worldwide.
*
...
* damage. Such applications are deemed, 鈥淚nsecure Usage鈥?.
*
*     All Insecure Usage shall be made at user鈥檚 risk. User shall indemnify NATIONS and hold NATIONS 
* harmless from and against all claims, costs, damages, and other liabilities, arising from or related 
* to any customer鈥檚 Insecure Usage.
