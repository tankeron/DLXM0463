...
#define PHASE_CORR_PERIOD_MS        20
#define PHASE_KI_NUM                1
#define PHASE_KI_DEN                64
#define PHASE_ERR_DEADBAND_COUNTS   4
#define PHASE_OFFSET_LIMIT_COUNTS   200
...
#define STALL_NO_TOGGLE_MS 800     /* 200~300ms 视机构阻尼调整 */
#endif
...
#define SYNC_ERR_CATCH_COUNTS   80//(HALL_CPR/2)
#endif
...
#ifndef SYNC_RECAPTURE_MAX_BOOST_DUTY
/* 大偏差重新并轨时，落后侧最多额外增加的占空（％） */
#define SYNC_RECAPTURE_MAX_BOOST_DUTY  6
#endif

#ifndef SYNC_RECAPTURE_MAX_BRAKE_DUTY
/* 大偏差重新并轨时，领先侧最多额外减少的占空（％） */
#define SYNC_RECAPTURE_MAX_BRAKE_DUTY  3
#endif

#ifndef SYNC_RECAPTURE_SLEW_PCT_PER_MS
/* 柔性并轨阶段，差动占空每 ms 的最大变化（％） */
#define SYNC_RECAPTURE_SLEW_PCT_PER_MS 1
#endif

#ifndef SYNC_RECAPTURE_RELEASE_MS
/* 退出大偏差追赶后，先稳定一小段时间再回正常同步（ms） */
#define SYNC_RECAPTURE_RELEASE_MS      40
#endif

#ifndef SYNC_RECAPTURE_START_COUNTS
/* 偏差超过该值开始进入柔性追赶 */
#define SYNC_RECAPTURE_START_COUNTS    120
#endif

#ifndef SYNC_RECAPTURE_FULL_COUNTS
/* 偏差达到该值后，柔性追赶输出到最大 */
#define SYNC_RECAPTURE_FULL_COUNTS     260
#endif
...
#define SYNC_CORR_SLEW_PCT_PER_MS   1           /* 纠偏每ms最大变化(百分点) */
